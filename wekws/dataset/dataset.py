...
def Dataset(data_list_file, conf,
    ...
    """ Construct dataset from arguments
        ...
        Args:
            ...
            white_noise: whether add gaussian white noise
    """
    ...
    white_noise = conf.get('white_noise', True)
    if white_noise:
        white_noise_conf = conf.get('white_noise_conf',{})
        dataset = Processor(dataset, processor.add_white_noise, **white_noise_conf)
